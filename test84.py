...
train_split_1, train_split_2 = cross_validation.train_test_split(train, test_size=0.7, random_state=0)
...
pipe = Pipeline([('select', SelectKBest(k=10)),
                 ('classify', RandomForestClassifier(random_state=20, max_features='sqrt'))])
...
clf = RandomForestClassifier(random_state = 20, warm_start = True,
                                  n_estimators = 24,
                                  max_depth = 10,
                                  max_features = 'sqrt')
...
submission.to_csv("submissionpanbo003.csv", index=False)

#print(gsearch.best_params_, gsearch.best_score_)

print("hello, dont warry")