...
if __name__=='__main__':
    ...
    train_data_org = pd.read_csv(r"D://studyPythonMl//kaggle_competition//Titannic//source_data//train.csv")
    test_data_org = pd.read_csv(r"D://studyPythonMl//kaggle_competition//Titannic//source_data//test.csv")
    ...
    # 3. Name
    # Title
    combined_train_test['Title'] = combined_train_test['Name'].values.extract('.+,(.+)').str.extract(
        '^(.+?)\.').str.strip()
